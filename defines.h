...
//普通数据包的结构：
//数据部分加上ID一共为1024
#define MAX_LENGTH 2000              //CSession中m_Data的长度
...
//在base64编码后，数据会变成4/3倍，762是转化成base64二进制前能读取的字节数
#define FILE_DATA_LEN_STRING 1019 //762
...
enum MSG_IDS {
    ...
    TellLostBag = 2010,      //Server端发出--告知丢包
