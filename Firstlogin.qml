...
Page {
    ...
    property string currentLoginType: "client"// 当前角色-client or server
            ...
            Button {
                ...
                onClicked: {
                    if(currentLoginType===""){
                        ...
                        if(currentLoginType==="client"){//client登陆
                            Controler.loginRequest(usernameField.text,passwordField.text,serverIpField.text,
                                                   function (response) {
                                                       if (response.error === 0) {
                                                           lodermainwindows()
                                                       }
